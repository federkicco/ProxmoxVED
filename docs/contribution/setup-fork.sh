...
# upstream   https://github.com/federkicco/ProxmoxVED.git (fetch)
# upstream   https://github.com/federkicco/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/federkicco/ProxmoxVED"
echo ""
