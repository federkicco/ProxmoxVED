...
# Repo: https://github.com/federkicco/ProxmoxVED
#
# Usage: bash -c "$(wget -qLO - https://github.com/federkicco/ProxmoxVED/raw/main/misc/hw-acceleration.sh)"
#
# Requires:
#   - Proxmox VE 8.1+
...
# https://github.com/federkicco/ProxmoxVED
...
source <(wget -qO- https://github.com/federkicco/ProxmoxVED/raw/main/tools/pve/gpu-nvidia.func)
source <(wget -qO- https://github.com/federkicco/ProxmoxVED/raw/main/tools/pve/gpu-intel.func)
source <(wget -qO- https://github.com/federkicco/ProxmoxVED/raw/main/tools/pve/gpu-amd.func)
